<?php
	abstract class ModeloAbstractoDB {
		...
		protected $db_name = "db_provincias_espana";
		protected $query;
		protected $rows = array();
		private $conexion;
		
		# mtodos abstractos para Gestin de clases que hereden
		...
		# los siguientes mtodos pueden definirse con exactitud y no son abstractos
